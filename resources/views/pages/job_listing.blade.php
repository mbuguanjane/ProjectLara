                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap text-center">
                                <h2>Get your Internship & Attachment</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4">
                        <div class="row">
                            <div class="col-12">
                                    ...
                                    <h4>Filter Internships and Attachment</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="job-category-listing mb-50">
                            ...
                            <div class="single-listing">
                               <div class="small-section-tittle2">
                                     <h4 id="Category">Internships Category</h4>
                               </div>
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="count-job mb-35">
                                            ...
                                            <span>{{count($internship)}} Internships and Attachment found</span>
                                            <!-- Select job items start -->
                                ...
                                <div class="single-job-items mb-30">
                                    ...
                                    <div class="items-link items-link2 f-right">
                                        ...
                                        <a href="/internships/{{$intern->id}}">Internship Details</a>
                                        
                                        <span>{{$intern->created_at}}</span>
